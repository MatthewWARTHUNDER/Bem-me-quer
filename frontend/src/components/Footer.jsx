        ...
        <footer className="bg-NavbarEfooter ">
            <div className="w-full max-w-screen-xl mx-auto p-4 py-6 lg:py-8">
                <div className="flex flex-col md:flex-row md:justify-between gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6 text-center md:text-left">
                        <div>
                            <h2 className="mb-4 text-sm font-semibold uppercase text-black">Entre em contato</h2>
                            <ul>
                                <li>
                        ...
                        <div>
                            <h2 className="mb-4 text-sm font-semibold uppercase text-black">Nossas mídias sociais</h2>
                            <ul>
                                <li>
                                    <a href="https://www.instagram.com/bem_me_quer_floresepresentes/?igsh=dmJnbTlucGN2ZW40#"
